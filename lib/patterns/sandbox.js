 ...
 *		* A callback function that expects `utils` (which exposes the methods
...
Sandbox.modules.events = function(utils) {
...
Sandbox.modules.dom = function(utils) {
	
	utils.addDomElement = function() {
		// ...
		return 'Just added a DOM element';
	};

	utils.removeDomElement = function() {
		// ...
